...
public class ExecuteArch {
    ...
    public static class MyThread implements Runnable{
        public void run(){
            System.out.println("Main Task repeating."+System.currentTimeMillis());
            try{
                Thread.sleep(1000);
            }catch (InterruptedException e){
                System.out.println("Main Task interrupted."+System.currentTimeMillis());
            }
        }
    }
     ...
     * 输出备用线程字符串
     */
    public static class SpareThread implements Runnable{
        public void run(){
            System.out.println("Spare Task repeating."+System.currentTimeMillis());
            try {
                Thread.sleep(1000);
            }catch(InterruptedException e){
                System.out.println("Spare Task interrupted."+System.currentTimeMillis());
            }
        }
    }
    ...
    public static class MyCallable implements Callable{
        ...
        public String call(){
            System.out.println("To cancel Task..."+ +System.currentTimeMillis());
    ...
    public static void main(String[] args)throws InterruptedException,ExecutionException{
        ...
        Future myThreadFuture = cachedService.submit(new MyThread());// FIXME: 2016/11/22 
        ...
        Callable myThreadCallable = Executors.callable(new SpareThread());
        Future myThreadCallableFuture = cachedService.submit(myThreadCallable);
        /**对于Runnable任务，转换成Called任务后，也没有返回值*/
        ...
        fixedService.submit(new SpareThread());
         ...
         */
        ScheduledExecutorService fixedScheduledService = Executors.newScheduledThreadPool(1);
        /**新建任务1*/
